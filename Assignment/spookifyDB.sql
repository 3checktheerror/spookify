...
CREATE TABLE contact_visitor_1 (
                                   ...
                                   `token` varchar(128),
                                   `session_id` varchar(128),
                                   `i_id_fk` varchar(32) NOT NULL,
                                   PRIMARY KEY (v_id),
                                   FOREIGN KEY (i_id_fk) REFERENCES contact_item_1(i_id)
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;;
...
INSERT INTO contact_item_1 (i_id, igroup_id, name, gender, email, file, md5, it_create, it_modified, op_type, data, token, session_id, status) VALUES ('SPIT000001', 'ITG1', 'QIU_FORM', 'Male', 'swe2109562@xmu.edu.my',NULL,NULL,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'Insert','{
  "i_id":"SPIT000001",
  "igroup_id":"ITG1",
  "name":"QIU_FORM",
  "gender":"Male",
...
INSERT INTO contact_visitor_1 (v_id, vgroup_id, name, username, password, age, gender, file, md5, vt_create, vt_modified, op_type, data, token, session_id, i_id_fk) VALUES ('SPVT000001','VTG1','Qiu Junyi','Ellen','123456',21,'Male',NULL,NULL,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'Insert',
                                                                                                                                                                             '{
                                                                                                                                                                               "name":"Qiu Junyi",
                                                                                                                                                                               "username":"Ellen",
                                                                                                                                                                               "password":"123456",
