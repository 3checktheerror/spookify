...
<%--                                <a v-if="!isCollapse" href="http://10.72.226.90:8082/getPage/test2.jsp">导航页1</a>--%>
...
<!--    Detail-->
    ...
    >
        ...
        <el-descriptions title="Information">
            ...
            <el-descriptions-item label="Last Modified">{{formatDate(detailForm.itModified)}}</el-descriptions-item>
    ...
    new Vue( {
        ...
        methods: {
            ...
            updateForm() {
                ...
                axios.post('/item/modifyItem', newData, {headers: {
                        'Content-Type': 'multipart/form-data'
                    }})
                    .then(response => {
            ...
            handleIndexPage1(){
                window.location.href = 'http://10.72.226.90:8082/getPage/test2';
            }
